...
[1.8 巨變：由單處理器轉移至多處理器](1-8-The-Sea-Change_The-Switch-from-Uniprocessors-to-Multiprocessors)
...
## 1-8 The Sea Change_ The Switch from Uniprocessors to Multiprocessors
